...
My take on this, presented at the **Azure Summit Event Mid-March 2023**, is based on this article:
...
Running APIs at scale? See [APIOps as Code](https://mohammed-brueckner.com/apiops/) — the API lifecycle from CI/CD to APIOps, documented as code.
