...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is a platform economy?",
      "acceptedAnswer": { "@type": "Answer", "text": "A platform economy is a market where value is created and captured through platforms — digital foundations that others build on — rather than through standalone products. The platform owner earns from other people's business models, not just from its own." }
    },
    {
      "@type": "Question",
      "name": "What is platform compression?",
      "acceptedAnswer": { "@type": "Answer", "text": "Platform compression is the collapse of the middle ground between infrastructure owners, platform owners, and feature owners. AI lets infrastructure and platform owners absorb features directly, leaving feature owners with no defensible ground." }
    },
    {
      "@type": "Question",
      "name": "Is my company a platform if it has an API?",
      "acceptedAnswer": { "@type": "Answer", "text": "No. A product with an API is not a platform. A platform is defined by what others build on it and what the owner earns from that. The test: would developers pay if you charged, and would partners build businesses on top of you?" }
    },
    {
      "@type": "Question",
      "name": "What is the Status-Quo Trap?",
      "acceptedAnswer": { "@type": "Answer", "text": "The Status-Quo Trap is responding to platform compression by optimizing the current business model instead of changing it — deploying AI as a productivity tool for the old model instead of a transformation engine for a new one." }
    },
    {
      "@type": "Question",
      "name": "Is platform compression only a tech-industry problem?",
      "acceptedAnswer": { "@type": "Answer", "text": "No. The mechanism — infrastructure absorbing features, platforms taxing ecosystems — works in any industry that touches software, which means every industry." }
    }
  ]
}
</script>
