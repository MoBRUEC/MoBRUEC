...
description: "Why more than 70% of projects still fail, and the Double Trinity Pyramid model that explains it: people, processes, technology meets incentivized, motivated, empowered."
---
...
The amazing fact that more than 70% of all "projects" fail still stands - [**explore my interactive Double Trinity Pyramid model to understand why that is and what we need to take into consideration to change that!**](https://mohammed-brueckner.com/changemanagement/double-trinity-change-model/)
...
BY THE WAY:
**Platform Economies** — launching September 1, 2026. [**Pre-order on Amazon**](https://www.amazon.com/dp/B0GXN4PRB5) — Kindle now; paperback September 1 ([🇬🇧 UK](https://www.amazon.co.uk/dp/B0GXN4PRB5), [🇩🇪 DE](https://www.amazon.de/dp/B0GXN4PRB5), [🇯🇵 JP](https://www.amazon.co.jp/dp/B0GXN4PRB5), [🇨🇦 CA](https://www.amazon.ca/dp/B0GXN4PRB5)). Platform compression is the biggest unmanaged change program of this decade — the book is the field guide. Book page: [mohammed-brueckner.com/platform-economies](https://mohammed-brueckner.com/platform-economies/).
...
**[🔗 Explore the Interactive Model](https://mohammed-brueckner.com/changemanagement/double-trinity-change-model/)**
...
📊 **[Experience the full interactive model](https://mohammed-brueckner.com/changemanagement/double-trinity-change-model/)** to explore warning signs, implementation strategies, and additional resources.
